...
sources = ['src/module_id_base.f90',
          ...
          'src/submodule_bnslorene_constructor.f90',
          'src/submodule_bnslorene_import.f90',
          'src/submodule_bnslorene_memory.f90',
          'src/submodule_bnslorene_access.f90',
          'src/submodule_bnslorene_params.f90',
          'src/submodule_bnslorene_mass_profile.f90',
